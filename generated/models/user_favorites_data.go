...
// UserFavoritesData user favorites data
// swagger:model UserFavoritesData
...
func (m *UserFavoritesData) validateData(formats strfmt.Registry) error {
...
func (m *UserFavoritesData) validateErrors(formats strfmt.Registry) error {
