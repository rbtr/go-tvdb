...
// NewPutUserFavoritesIDParams creates a new PutUserFavoritesIDParams object
// with the default values initialized.
func NewPutUserFavoritesIDParams() *PutUserFavoritesIDParams {
	var ()
	return &PutUserFavoritesIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPutUserFavoritesIDParamsWithTimeout creates a new PutUserFavoritesIDParams object
...
// NewPutUserFavoritesIDParamsWithContext creates a new PutUserFavoritesIDParams object
...
// NewPutUserFavoritesIDParamsWithHTTPClient creates a new PutUserFavoritesIDParams object
...
/*PutUserFavoritesIDParams contains all the parameters to send to the API endpoint
for the put user favorites ID operation typically these are written to a http.Request
*/
...
func (o *PutUserFavoritesIDParams) WithTimeout(timeout time.Duration) *PutUserFavoritesIDParams {
...
func (o *PutUserFavoritesIDParams) WithContext(ctx context.Context) *PutUserFavoritesIDParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PutUserFavoritesIDParams) WithID(id int64) *PutUserFavoritesIDParams {
	o.SetID(id)
	return o
}
...
func (o *PutUserFavoritesIDParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
