...
// NewGetRefreshTokenParamsWithTimeout creates a new GetRefreshTokenParams object
...
// NewGetRefreshTokenParamsWithContext creates a new GetRefreshTokenParams object
...
// NewGetRefreshTokenParamsWithHTTPClient creates a new GetRefreshTokenParams object
...
/*GetRefreshTokenParams contains all the parameters to send to the API endpoint
for the get refresh token operation typically these are written to a http.Request
*/
...
func (o *GetRefreshTokenParams) WithContext(ctx context.Context) *GetRefreshTokenParams {
	o.SetContext(ctx)
	return o
}
